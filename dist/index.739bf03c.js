...
const openItem = (item)=>{
    ...
    .addLabel("articleOpening", typeT.in().totalDuration() * .75 + openTimeline.labels.typeTransition)// fade out the items
    ...
    .add(()=>{
        ...
        (0, _gsapCoreDefault.default).set(itemsWrap, {
            pointerEvents: "none"
        });
...
const closeItem = ()=>{
    ...
    .add(typeT.out().play(), "typeTransition").to(frameEl, {
        ...
        ease: "power3",
        opacity: 1,
        onStart: ()=>(0, _gsapCoreDefault.default).set(frameEl, {
                pointerEvents: "auto"
            })
...
class Item {
    ...
    constructor(DOM_el){
        ...
        this.DOM.el.addEventListener("mouseenter", ()=>{
            (0, _gsapCoreDefault.default).timeline({
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["b3anl","ebWYT"], "ebWYT", "parcelRequire5b73")
